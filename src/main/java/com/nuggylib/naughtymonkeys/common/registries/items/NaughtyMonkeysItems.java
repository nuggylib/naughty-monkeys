...
public class NaughtyMonkeysItems {
    ...
    public static final RegistryObject<Item> BANANA_STEM_ITEM = ITEMS.register("banana_stem", () -> new BlockItem(NaughtyMonkeysBlocks.BANANA_STEM.get(), new Item.Properties().tab(NaughtyMonkeys.TAB_NAUGHTY_MONKEYS)));
    public static final RegistryObject<Item> BANANA_SAPLING_ITEM = ITEMS.register("banana_sapling", () -> new BlockItem(NaughtyMonkeysBlocks.BANANA_SAPLING.get(), new Item.Properties().tab(NaughtyMonkeys.TAB_NAUGHTY_MONKEYS)));
