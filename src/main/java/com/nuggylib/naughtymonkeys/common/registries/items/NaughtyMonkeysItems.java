...
public class NaughtyMonkeysItems {
    ...
    public static final RegistryObject<Item> BANANA_BLOCK_ITEM = ITEMS.register("banana_block", () -> new BlockItem(NaughtyMonkeysBlocks.BANANA_BLOCK.get(), new Item.Properties().tab(NaughtyMonkeys.TAB_NAUGHTY_MONKEYS)));
