...
public class NaughtyMonkeysSounds {
    ...
    public static final RegistryObject<SoundEvent> MONKEY_POO_SPLAY = SOUNDS.register("entity.monkey_poo.hit", () -> new SoundEvent(new ResourceLocation("entity.monkey_poo.hit")));
