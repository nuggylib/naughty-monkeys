...
public abstract class AbstractMonkeyPoo extends Projectile {
    ...
    protected AbstractMonkeyPoo(EntityType<? extends AbstractMonkeyPoo> p_36721_, Level p_36722_) {
        super(p_36721_, p_36722_);
    }

    protected AbstractMonkeyPoo(EntityType<? extends AbstractMonkeyPoo> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
    ...
    protected void onHitEntity(EntityHitResult p_36757_) {
        ...
        if (entity1 == null) {
            damagesource = NaughtyMonkeysDamageSource.monkeyPoo(this, this);
        } else {
            damagesource = NaughtyMonkeysDamageSource.monkeyPoo(this, entity1);
    ...
    public static enum Pickup {
        ...
        public static AbstractMonkeyPoo.Pickup byOrdinal(int p_36809_) {
